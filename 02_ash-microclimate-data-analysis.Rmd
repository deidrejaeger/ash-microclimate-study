...
#combine diff columns into one column or add columns with difference titles, then use as the new data and include facets for the difference titles


ggplot(data = ash_data3_before) +
  geom_histogram(mapping = aes(x = tempF_diff, y = stat(density), fill = ash_removal), position = "identity", bins = 36, alpha = 0.6)
