...
```{r view-histograms-by-sensor, results = TRUE, fig.cap = "Figure 1. Histograms of the temperature value distributions from each sensor during each treatment phase"}
