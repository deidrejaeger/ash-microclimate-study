...
*Step 4:* average the two ash treatment replicates

*Step 5:* combined time series plots for all 3 groups (treatment-tree, control-tree, control-sun)
...
```{r view-time-series-scatterplot}
